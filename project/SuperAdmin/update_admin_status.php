...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bind_param("ii", $status_action, $admin_id);
    $stmt->execute();
    ...
    $stmt2->bind_param("ii", $status_action, $admin_id);
    $stmt2->execute();
    ...
    $emailResult = sendAdminStatusEmail($admin_id, $changed_by, $status_action, $subject, $body, $warning, $_FILES['attachments'] ?? null);
