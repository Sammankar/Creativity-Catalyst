...
function sendAccessChangeEmail($user_id, $changed_by, $new_access, $subject, $body, $warning, $attachments) {
    ...
    $uploadDir = __DIR__ . '/images/admin_access_reports/';
    ...
    try {
        ...
        $stmt = $db->prepare("INSERT INTO access_denial_reports (user_id, changed_by, old_access, new_access, subject, body, warning, attachment) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        $query = "INSERT INTO chat_reports (report_id, locked) VALUES (?, 0)";
