...
if (!isset($_GET['report_id'])) {
    header("Location: evalutor_access_reports_logs.php");
    exit();
}

$report_id = $_GET['report_id'];

// Fetch the report details with evaluator and Super-evaluator names, including attachment
$query = "SELECT 
            adr.*, 
...
<body class="bg-gray-100">
    <div class="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg mt-10">
        ...
        <div class="mt-4">
            ...
            <p class="text-lg font-semibold">evaluator Name: <span class="font-normal"><?php echo htmlspecialchars($report['user_name']); ?></span></p>
            <p class="text-lg font-semibold">Access Restricted by (Super-evaluator): <span class="font-normal"><?php echo htmlspecialchars($report['changed_by_name']); ?></span></p>
        </div>
    ...
    ?>
    <a href="evaluator_download.php?file=<?php echo urlencode(basename($attachment)); ?>" class="ml-2 px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600">
        Download Attachment
    </a>
<?php else : ?>
...
<?php endif; ?>
        ...
        <div class="mt-6 flex justify-end">
            <a href="evaluator_access_reports_logs.php" class="px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600">Back to Reports</a>
        </div>
    </div>
</body>
</html>
