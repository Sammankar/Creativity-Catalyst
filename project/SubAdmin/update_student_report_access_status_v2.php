...
include 'student_sendAccessStatusMail.php'; // Include the mail function
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($action === "grant") {
            ...
            $updateReport = $conn->prepare("UPDATE student_access_denial_reports SET access_denial_report_status = 1, previous_access_status = ?, current_access_status = ? WHERE id = ?");
