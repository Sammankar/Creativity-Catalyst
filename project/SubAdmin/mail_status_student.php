...
function sendstudentStatusEmail($student_id, $changed_by, $new_status, $subject, $body, $warning, $attachments) {
    $mail = new PHPMailer(true);
    $uploadDir = __DIR__ . '/images/student_status_report/';  // Make sure this path is correct
    $attachmentPaths = [];
