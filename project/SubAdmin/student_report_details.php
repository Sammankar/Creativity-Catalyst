...
$attachments = json_decode($report['attachments'], true); // Decode JSON into an array
...
<body class="bg-gray-100">
    <div class="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg mt-10">
        ...
        <div class="mt-4">
            ...
            <p class="text-lg font-semibold">Created On: <span class="font-normal"><?php echo date('d M Y, g:i A', strtotime($report['updated_at'])); ?></span></p>
            ...
            <p class="text-lg font-semibold">student Name: <span class="font-normal"><?php echo htmlspecialchars($report['user_name']); ?></span></p>
    ...
    ?>
    <a href="student_download.php?file=<?php echo urlencode(basename($attachment)); ?>" class="ml-2 px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600">
        Download Attachment
    </a>
<?php else : ?>
...
<?php endif; ?>
        ...
        <div class="mt-6 flex justify-end">
            <a href="student_access_logs.php" class="px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600">Back to Reports</a>
        </div>
    </div>
</body>
</html>
