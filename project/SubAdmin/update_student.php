...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($stmt->execute()) {
      ...
      $_SESSION['message'] = "Failed To Update Student Details!";
      $_SESSION['message_type'] = "error";
  }
        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="guide_allocation_list.php"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
...
<main class="h-full overflow-y-auto  mt-8">
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
        <h1 class="text-xl font-semibold mb-4">Update Student Details</h1>
        <form method="POST" action="">
            <div class="mb-4">
                <label for="full_name" class="block text-sm font-medium text-gray-700">Student Name</label>
