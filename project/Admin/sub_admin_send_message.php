...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $lock_query = "SELECT locked FROM sub_admin_chat_reports WHERE report_id = ?";
    ...
    $stmt = $conn->prepare("INSERT INTO sub_admin_chat_messages (report_id, sender_id, receiver_id, message) VALUES (?, ?, ?, ?)");
