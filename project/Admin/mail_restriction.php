...
function sendAccessChangeEmail($user_id, $changed_by, $new_access, $subject, $body, $warning, $attachments) {
    ...
    $uploadDir = __DIR__ . '/images/sub_admin_access_reports/';
    ...
    try {
        ...
        $stmt = $db->prepare("INSERT INTO teacher_access_denial_reports (user_id, changed_by, old_access, new_access, subject, body, warning, attachment) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        $query = "INSERT INTO sub_admin_chat_reports (report_id, locked) VALUES (?, 0)";
