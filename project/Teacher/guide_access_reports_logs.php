...
<head>
    ...
    <title>Guide Access Reports</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100">
    <div class="max-w-6xl mx-auto p-4">
        <h1 class="text-3xl font-extrabold text-gray-800 mb-6">Guide Access Reports</h1>
    ...
    <script>
        function expandReport(reportId) {
            window.location.href = "guide_access_report_log_details.php?report_id=" + reportId;
        }
