...
$sql = "
    SELECT users.*, courses.name AS course_name, colleges.name AS college_name
    FROM users
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="md:w-1/2 p-4">
                        ...
                        <label class="block mt-2 text-sm font-medium text-gray-700">Course</label>
                        <input type="text" class="w-full mt-1 p-2 border rounded-md" value="<?= htmlspecialchars($user['course_name']); ?>" readonly />
                        <label class="block mt-2 text-sm font-medium text-gray-700">College</label>
