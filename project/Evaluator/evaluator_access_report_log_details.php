...
<body class="bg-gray-100">
    <div class="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg mt-10">
        ...
        <div class="mt-4">
            ...
            <p class="text-lg font-semibold">Access Restricted by (Evaluator): <span class="font-normal"><?php echo htmlspecialchars($report['changed_by_name']); ?></span></p>
        </div>
...
<?php endif; ?>
        ...
        <div class="mt-6 flex justify-end">
            <a href="Access_reports_logs.php" class="px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600">Back to Reports</a>
        </div>
    </div>
</body>
</html>
