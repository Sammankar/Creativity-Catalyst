...
if ($stage_id == 0) {
    echo "<div class='p-4 text-red-600'>Invalid stage selected.</div>";
    exit;
}
...
// Fetch submission details for current user
...
<main class="h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
    <div class="w-full max-w-2xl mx-auto p-4">
        ...
        <h2 class="text-xl font-semibold text-center text-gray-700 dark:text-gray-200 mb-6">Stage Details</h2>
            ...
            <div class="mb-4">
                <label class="block font-semibold text-gray-700 dark:text-gray-200">Number of Files:</label>
    ...
    <div class="mb-4">
        ...
        <div class="flex flex-col space-y-2">
            <?php foreach ($submitted_files as $index => $file): ?>
                <div class="flex items-center justify-between bg-gray-100 dark:bg-gray-700 px-4 py-2 rounded-md">
                    <span class="text-gray-800 dark:text-gray-100">File <?= $index + 1 ?></span>
                    <a href="images/stages/<?= htmlspecialchars($file) ?>" download
                       class="px-4 py-2 bg-green-600 text-black rounded-md hover:bg-green-700 transition duration-200">
                        Download
                    </a>
                </div>
            <?php endforeach; ?>
